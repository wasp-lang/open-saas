  ...
  return (
    <div>
      ...
      >
        ...
        >
          <span
            className={cn('absolute inset-0 flex items-center justify-center transition-opacity ease-in-out duration-400', {
              'opacity-0': colorMode === 'dark',
              'opacity-100': colorMode === 'light',
            })}
          >
          ...
          <span
            className={cn('absolute inset-0 flex items-center justify-center transition-opacity ease-in-out duration-400', {
              'opacity-0': colorMode === 'light',
              'opacity-100': colorMode === 'dark',
            })}
          >
            <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
              <path
