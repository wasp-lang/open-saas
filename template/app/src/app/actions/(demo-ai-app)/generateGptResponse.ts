...
import { type GptResponse, type Task, type User } from "wasp/entities";
import { env, HttpError, prisma } from "wasp/server";
import { type GenerateGptResponse } from "wasp/server/operations";
import * as z from "zod";
import {
  type GeneratedSchedule,
  generatedScheduleSchema,
} from "../../../demo-ai-app/schedule";
...
const generateGptResponse: GenerateGptResponse<
