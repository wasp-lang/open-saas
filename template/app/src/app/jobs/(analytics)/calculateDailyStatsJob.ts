...
import {
  getDailyPageViews,
  getSources,
} from "../../../analytics/providers/plausibleAnalyticsUtils";
// import { getDailyPageViews, getSources } from '../../../analytics/providers/googleAnalyticsUtils';
import { paymentProcessor } from "../../../payment/paymentProcessor";
import { SubscriptionStatus } from "../../../payment/plans";

const calculateDailyStatsJob: CalculateDailyStatsJob<never, void> = async (
  _args,
  context,
) => {
  ...
  try {
    ...
    await context.entities.Logs.create({
      data: {
        message: `Error calculating daily stats: ${
...
export default calculateDailyStatsJob;
