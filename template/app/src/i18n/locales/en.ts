export const enTranslations = {
  ...
  "admin": {
    ...
    "buttons": "Buttons",
    "noDailyStats": "No daily stats generated yet",
    "noDailyStatsDescription": "Stats will appear here once the daily stats job has run",
    ...
    "totalProfitLast7Days": "Total Profit Last 7 Days",
    "totalRevenueLast7Days": "Total Revenue Last 7 Days",
    "day": "Day",
    "week": "Week",
    "month": "Month",
    "filters": "Filters",
    ...
    "yourPlan": "Your Plan",
    "about": "About",
    "imACoolCustomer": "I'm a cool customer.",
    "creditsRemaining": "Credits remaining",
    "buyMoreUpgrade": "Buy More/Upgrade",
    "manageSubscription": "Manage Subscription",
    "paymentPastDue": "Payment for your {planName} plan is past due! Please update your subscription payment information.",
    "subscriptionCanceled": "Your {planName} plan subscription has been canceled, but remains active until the end of the current billing period{endOfBillingPeriod}",
    "subscriptionDeleted": "Your previous subscription has been canceled and is no longer active.",
    ...
    "resetIt": "reset it",
    "ifEverythingIsOkay": "If everything is okay,",
  ...
  "landing": {
    "hero": {
      ...
      "subtitle": "Build your SaaS application with superpowers",
      "description": "A fully open-source SaaS template with authentication, payments, file uploads, and more.",
      "cta": "Get Started",
      "learnMore": "Learn More"
    },
    "features": {
    ...
    "footer": {
      "description": "Your Open SaaS App - Built with superpowers",
      "copyright": "© 2024 Your Open SaaS App. All rights reserved."
    }
  },
  "auth": {
    "login": {
