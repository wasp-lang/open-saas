...
banner:
  content: >
    ...
    swag! 👕</a>
slug: 0.23/guides/authentication
---
...
Since it needs to send emails to verify users and reset passwords, it requires an [email sender](https://wasp.sh/docs/0.23/advanced/email) provider: a service it can use to send emails.
...
1. First, set up your app's `emailSender` in the `main.wasp` file by following [this guide](/0.23/guides/email-sending/#integrate-your-email-sender).
...
Check out the  [Wasp Auth docs](https://wasp.sh/docs/0.23/auth/overview) for more info.
...
To create a Google OAuth app and get your Google API keys, follow the instructions in [Wasp's Google Auth docs](https://wasp.sh/docs/0.23/auth/social-auth/google#3-creating-a-google-oauth-app).

To create a GitHub OAuth app and get your GitHub API keys, follow the instructions in [Wasp's GitHub Auth docs](https://wasp.sh/docs/0.23/auth/social-auth/github#3-creating-a-github-oauth-app).

To create a Discord OAuth app and get your Discord API keys, follow the instructions in [Wasp's Discord Auth docs](https://wasp.sh/docs/0.23/auth/social-auth/discord#3-creating-a-discord-app)
