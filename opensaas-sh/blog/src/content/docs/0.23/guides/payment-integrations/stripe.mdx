...
banner:
  content: >
    ...
    swag! 👕</a>
slug: 0.23/guides/payment-integrations/stripe
---
...
First, make sure you've defined your payment processor in `src/payment/paymentProcessor.ts`, as described in the [important first steps](/0.23/guides/payment-integrations/).
...
:::note
If you want to learn more about how a user's payment status, subscription status, and subscription tier affect a user's priveledges within the app, check out the [User Overview](/0.23/general/user-overview/) reference.
:::
