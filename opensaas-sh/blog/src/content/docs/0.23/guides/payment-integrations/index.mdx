...
banner:
  content: >
    ...
    swag! 👕</a>
slug: 0.23/guides/payment-integrations
---
...
Once you're ready to deploy your app, follow the steps from the [deploying guide](/0.23/guides/deploying/) to set up the production settings for your prayment provider.
