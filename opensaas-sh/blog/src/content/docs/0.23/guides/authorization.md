...
banner:
  content: >
    ...
    swag! 👕</a>
slug: 0.23/guides/authorization
---
...
Authorization differs from [authentication](/0.23/guides/authentication/) in that authentication refers to the process of verifying that a user is who they say they are (e.g. logging in with a username and password).

To learn more about the different types of user permissions built into this SaaS template, including Stripe subscription tiers and statuses, check out the [User Overview Reference](/0.23/general/user-overview/).
