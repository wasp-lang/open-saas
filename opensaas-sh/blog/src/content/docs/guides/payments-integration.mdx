...
<Image src={addPolarToken} alt="How to create a new access token in Polar dashboard" loading="lazy" />
...
<Image src={addPolarProduct} alt="How to create a new product in Polar dashboard" loading="lazy" />
