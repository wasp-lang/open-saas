...
import kivo from '../client/static/examples/kivo.png';
import messync from '../client/static/examples/messync.png';
import microinfluencerClub from '../client/static/examples/microinfluencers.png';
import promptpanda from '../client/static/examples/promptpanda.png';
import reviewradar from '../client/static/examples/reviewradar.png';
import scribeist from '../client/static/examples/scribeist.png';
import searchcraft from '../client/static/examples/searchcraft.png';
