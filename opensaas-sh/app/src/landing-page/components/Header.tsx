...
export default function Header({ navigation, setShowCookieBanner }: { navigation: NavigationItem[], setShowCookieBanner: any }) {
  ...
  return (
    <header className='absolute inset-x-0 top-0 z-50 dark:bg-boxdark-2'>
      <Announcement setShowCookieBanner={setShowCookieBanner} />
...
function Announcement({ setShowCookieBanner }: { setShowCookieBanner: any }) {
  return (
    <div className='flex justify-center items-center gap-3 p-3 w-full bg-gradient-to-r from-[#d946ef] to-[#fc0] font-semibold text-white text-center z-49'>
      <p className='hidden lg:block'>🍪 THE MOST ANNOYING COOKIE CONSENT BANNER CONTEST 2024 🤬</p>
