        ...
        {providers.map((provider) => {
          ...
          return (
            <Button
              ...
              variant={selectedProviders.includes(provider.name) ? 'outline' : 'default'}
            >
...
const AuthExample = ({ selectedProviders }: { selectedProviders: AuthProvider[] }) => {
  return (
    <Card className='py-10 max-w-md transition-all duration-300 ease-in-out'>
      <CardHeader>
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex flex-row gap-2'>
              {selectedProviders.map((provider) => {
                ...
                return (
                  <Button key={provider} className='w-full mb-2' variant='outline'>
